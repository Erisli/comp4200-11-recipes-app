...
public class valuessaver {
    public static String imgurl , tittle ,sevinglist,instructionlist,nutritionlist, ingredients;
    public static JSONArray ingarray;
    public static String[] instruction = {"Cooking Instruction Summary:\n" +
    ...
    public static String[] nutrition ={"521k Calories\n" +
            "35g Protein\n" +
            "10g Total Fat\n" +
            "69g Carbs\n" +
            "20% Score",
