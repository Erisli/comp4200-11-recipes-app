...
public class RecipeList extends AppCompatActivity {
            ...
            JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                    new Response.Listener<JSONArray>() {
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            Log.d("out try", "Working");
                            try {

                                Log.d("in response", "Working");
                ...
                public void onErrorResponse(VolleyError error) {
                    Log.d("in ErrorResponse", String.valueOf(error));
                }
            });
    ...
    public void setRecyclerItems() {
        recipeImages.addAll(FileHandler.readFromFile(RecipeList.this,"recipeimages.dat"));
        recipeTitles.addAll(FileHandler.readFromFile(RecipeList.this,"recipetitles.dat"));
        recipeDietary.addAll(FileHandler.readFromFile(RecipeList.this,"recipedietary.dat"));
        recipeInstruction.addAll(FileHandler.readFromFile(RecipeList.this,"recipeInstruction.dat"));

        recipeServings.addAll(FileHandler.readFromFileInt(RecipeList.this,"recipeservings.dat"));
        recipePreparation.addAll(FileHandler.readFromFileInt(RecipeList.this,"recipepreparation.dat"));

        recipeVegan.addAll(FileHandler.readFromFileInt(RecipeList.this,"recipeVegan.dat"));
        recipeVegetarian.addAll(FileHandler.readFromFileInt(RecipeList.this,"recipeVegetarian.dat"));
        recipeGlutenFree.addAll(FileHandler.readFromFileInt(RecipeList.this,"recipeGlutenFree.dat"));
        recipeDiaryFree.addAll(FileHandler.readFromFileInt(RecipeList.this,"recipeDiaryFree.dat"));
    ...
    public void saveItems(){
        FileHandler.writeToFile(RecipeList.this, recipeImages, "recipeimages.dat");
        FileHandler.writeToFile(RecipeList.this, recipeTitles, "recipetitles.dat");
        FileHandler.writeToFile(RecipeList.this, recipeDietary, "recipedietary.dat");
        FileHandler.writeToFile(RecipeList.this, recipeInstruction, "recipeInstruction.dat");

        FileHandler.writeToFileInt(RecipeList.this, recipeServings, "recipeservings.dat");
        FileHandler.writeToFileInt(RecipeList.this, recipePreparation, "recipepreparation.dat");

        FileHandler.writeToFileInt(RecipeList.this, recipeGlutenFree, "recipeGlutenFree.dat");
        FileHandler.writeToFileInt(RecipeList.this, recipeDiaryFree, "recipeDiaryFree.dat");
        FileHandler.writeToFileInt(RecipeList.this, recipeVegan, "recipeVegan.dat");
        FileHandler.writeToFileInt(RecipeList.this, recipeVegetarian, "recipeVegetarian.dat");
    }

    public void setRecyclerAdapter(){
        adapter = new RecyclerAdapter(RecipeList.this, recipeImages, recipeTitles, recipeDietary,
                recipeServings, recipePreparation,recipeIngredient,recipeInstruction);
        recycler.setLayoutManager(new LinearLayoutManager(RecipeList.this));
